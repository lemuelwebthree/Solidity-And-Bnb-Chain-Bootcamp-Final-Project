...
contract ModifierExample {
    ...
    // modifier is an automatic condition checker that can be added
    ...
    // think of modifiers as function-execution gatekeepers used
    // to create "permissioned" functions in solidity. Makes sense?
    // Great!
